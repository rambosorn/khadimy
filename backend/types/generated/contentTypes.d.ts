...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instructor: Schema.Attribute.Relation<'oneToOne', 'api::expert.expert'>;
    is_slideshow: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    who_is_for: Schema.Attribute.JSON;
  };
}
...
export interface ApiHomeHeroHomeHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    background_style: Schema.Attribute.Enumeration<
      ['globe_animation', 'static_image', 'gradient']
    > &
      Schema.Attribute.DefaultTo<'globe_animation'>;
    badge_left_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Industry Certified'>;
    badge_right_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'500+ Students'>;
    cohort_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\uD83D\uDE80 New Cohorts Starting January 2026'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    primary_button_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'View Courses'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    secondary_button_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Join Community'>;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry partners and trust certifications';
    displayName: 'Partner';
    pluralName: 'partners';
