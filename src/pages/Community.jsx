                                            ...
                                            <div style={{ padding: '2rem', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                                ...
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem', gap: '1rem' }}>
                                                    <div>
                                                        ...
                                                        {/* Metadata */}
                                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', color: '#666', fontSize: '1rem' }}>
                                                    ...
                                                    {/* Big Date Display */}
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', lineHeight: 1, flexShrink: 0 }}>
